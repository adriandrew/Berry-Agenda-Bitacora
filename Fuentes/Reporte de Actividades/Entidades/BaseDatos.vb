...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionInformacion()
        ...
        BaseDatos.ECadenaConexionInformacion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaReporteActividades.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionInformacion, LogicaReporteActividades.DatosEmpresaPrincipal.usuarioSql, LogicaReporteActividades.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaReporteActividades.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionCatalogo, LogicaReporteActividades.DatosEmpresaPrincipal.usuarioSql, LogicaReporteActividades.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionAgenda()
        ...
        BaseDatos.ECadenaConexionAgenda = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaReporteActividades.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionAgenda, LogicaReporteActividades.DatosEmpresaPrincipal.usuarioSql, LogicaReporteActividades.DatosEmpresaPrincipal.contrasenaSql)
