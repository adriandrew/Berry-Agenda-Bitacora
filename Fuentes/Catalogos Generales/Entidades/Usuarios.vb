...
Public Class Usuarios
    ...
    Public Function ObtenerListadoPorId() As List(Of Usuarios)
        ...
        Try
            ...
            comando.CommandText = "SELECT * FROM Usuarios WHERE IdEmpresa=@idEmpresa AND IdArea=@idArea AND Id=@id"
    ...
    Public Function ObtenerListadoReporte() As DataTable
        ...
        Try
            ...
            Dim comando As New SqlCommand()
            comando.Connection = BaseDatos.conexionInformacion
            comando.CommandText = "SELECT Id, Nombre FROM Usuarios WHERE IdEmpresa=@idEmpresa AND IdArea=@idArea AND Id<>@id ORDER BY Id ASC"
            comando.Parameters.AddWithValue("@idEmpresa", Me.EIdEmpresa)
            comando.Parameters.AddWithValue("@idArea", Me.EIdArea)
            comando.Parameters.AddWithValue("@id", Me.EId)
            BaseDatos.conexionInformacion.Open()
