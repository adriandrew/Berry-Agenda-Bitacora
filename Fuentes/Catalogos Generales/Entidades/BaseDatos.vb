...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionInformacion()
        ...
        BaseDatos.ECadenaConexionInformacion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaCatalogosGenerales.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionInformacion, LogicaCatalogosGenerales.DatosEmpresaPrincipal.usuarioSql, LogicaCatalogosGenerales.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaCatalogosGenerales.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionCatalogo, LogicaCatalogosGenerales.DatosEmpresaPrincipal.usuarioSql, LogicaCatalogosGenerales.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionAgenda()
        ...
        BaseDatos.ECadenaConexionAgenda = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaCatalogosGenerales.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionAgenda, LogicaCatalogosGenerales.DatosEmpresaPrincipal.usuarioSql, LogicaCatalogosGenerales.DatosEmpresaPrincipal.contrasenaSql)
