...
Public Class Principal
    ...
    Dim actividades As New EntidadesAutorizaciones.Actividades
...
#Region "Eventos"
    ...
    Private Sub cbTipo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbTipo.SelectedIndexChanged
        ...
        If (Me.opcionSeleccionada = OpcionesMenu.Evidencias) Then
            CargarEvidenciasSpread()
        End If
...
#Region "Todos"
    ...
    Private Sub CargarAutorizacionesSpread()
        ...
        If (Me.estaMostrado) Then
            Me.Cursor = Cursors.WaitCursor
            LimpiarSpread()
            Dim lista As New List(Of EntidadesAutorizaciones.Actividades)
