...
Public Class ActividadesExternas
    ...
    Public Function ObtenerListadoPendientesExternas() As List(Of ActividadesExternas)
        ...
        Try
            ...
            " WHERE A.IdAreaDestino=@idArea AND A.IdUsuarioDestino=@idUsuario AND AR.IdActividad IS NULL AND AR.IdArea IS NULL AND (A.EsAutorizado = 'FALSE' OR A.EsAutorizado IS NULL)"
