...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionInformacion()
        ...
        BaseDatos.ECadenaConexionInformacion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaControl.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionInformacion, LogicaControl.DatosEmpresaPrincipal.usuarioSql, LogicaControl.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaControl.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionCatalogo, LogicaControl.DatosEmpresaPrincipal.usuarioSql, LogicaControl.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionAgenda()
        ...
        BaseDatos.ECadenaConexionAgenda = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaControl.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionAgenda, LogicaControl.DatosEmpresaPrincipal.usuarioSql, LogicaControl.DatosEmpresaPrincipal.contrasenaSql)
