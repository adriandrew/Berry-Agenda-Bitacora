...
Public Class ActividadesExternas
    ...
    Public Function ObtenerListadoPendientesExternas() As List(Of ActividadesExternas)
        ...
        Try
            ...
            " WHERE A.IdAreaDestino=@idArea AND A.IdUsuarioDestino=@idUsuario AND AR.IdActividad IS NULL AND AR.IdArea IS NULL AND CONVERT(CHAR(10), A.FechaVencimiento, 121) < CONVERT(CHAR(10), GETDATE(), 121) " & _
