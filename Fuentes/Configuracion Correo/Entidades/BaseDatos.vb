...
Public Module BaseDatos
    ...
    Public Sub AbrirConexionInformacion()
        ...
        BaseDatos.ECadenaConexionInformacion = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaConfiguracionCorreo.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionInformacion, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.usuarioSql, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionCatalogo()
        ...
        BaseDatos.ECadenaConexionCatalogo = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaConfiguracionCorreo.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionCatalogo, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.usuarioSql, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.contrasenaSql)
    ...
    Public Sub AbrirConexionAgenda()
        ...
        BaseDatos.ECadenaConexionAgenda = String.Format("Data Source={0};Initial Catalog={1};User Id={2};Password={3}", LogicaConfiguracionCorreo.DatosEmpresaPrincipal.instanciaSql, BaseDatos.ECadenaConexionAgenda, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.usuarioSql, LogicaConfiguracionCorreo.DatosEmpresaPrincipal.contrasenaSql)
